...
class QueryClient extends $grpc.Client {
  ...
  static final _$allowancesByGranter = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $1.QueryAllowancesByGranterResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.QueryAllowancesByGranterResponse> allowancesByGranter(
      $1.QueryAllowancesByGranterRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.QueryAllowancesByGranterRequest,
            $1.QueryAllowancesByGranterResponse>(
        'AllowancesByGranter',
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.QueryAllowancesByGranterRequest.fromBuffer(value),
  ...
  $async.Future<$1.QueryAllowancesByGranterResponse> allowancesByGranter_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.QueryAllowancesByGranterRequest> request) async {
  ...
  $async.Future<$1.QueryAllowancesByGranterResponse> allowancesByGranter(
      $grpc.ServiceCall call, $1.QueryAllowancesByGranterRequest request);
}
