...
class QueryAllowancesByGranterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAllowancesByGranterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'granter')
    ..aOM<$7.PageRequest>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $7.PageRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryAllowancesByGranterRequest clone() => QueryAllowancesByGranterRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryAllowancesByGranterRequest copyWith(void Function(QueryAllowancesByGranterRequest) updates) => super.copyWith((message) => updates(message as QueryAllowancesByGranterRequest)) as QueryAllowancesByGranterRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryAllowancesByGranterRequest create() => QueryAllowancesByGranterRequest._();
  QueryAllowancesByGranterRequest createEmptyInstance() => create();
  static $pb.PbList<QueryAllowancesByGranterRequest> createRepeated() => $pb.PbList<QueryAllowancesByGranterRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryAllowancesByGranterRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryAllowancesByGranterRequest>(create);
...
class QueryAllowancesByGranterResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAllowancesByGranterResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
    ..pc<$6.Grant>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowances', $pb.PbFieldType.PM, subBuilder: $6.Grant.create)
    ..aOM<$7.PageResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagination', subBuilder: $7.PageResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryAllowancesByGranterResponse clone() => QueryAllowancesByGranterResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryAllowancesByGranterResponse copyWith(void Function(QueryAllowancesByGranterResponse) updates) => super.copyWith((message) => updates(message as QueryAllowancesByGranterResponse)) as QueryAllowancesByGranterResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryAllowancesByGranterResponse create() => QueryAllowancesByGranterResponse._();
  QueryAllowancesByGranterResponse createEmptyInstance() => create();
  static $pb.PbList<QueryAllowancesByGranterResponse> createRepeated() => $pb.PbList<QueryAllowancesByGranterResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryAllowancesByGranterResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryAllowancesByGranterResponse>(create);
